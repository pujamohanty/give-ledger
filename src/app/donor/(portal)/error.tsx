...
export default function DonorPortalError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    // Log error to console so it shows in Vercel function logs
    console.error("[DonorPortal Error]", error.message, error.digest, error.stack);
  }, [error]);
