        ...
        {isEmpty ? (
          <div className="px-6 py-10 text-center">
            ...
            <p className="text-sm text-gray-500 mb-4">
              No suggested roles yet. Click &ldquo;Generate&rdquo; to have AI analyse this organisation.
            </p>
            <button
              onClick={generate}
              disabled={loading}
            ...
            >
              <Sparkles className="w-4 h-4" /> Generate Role Profiles
            </button>
          </div>
        ) : loading ? (
          <div className="px-6 py-10 text-center">
            <RefreshCw className="w-6 h-6 text-violet-400 animate-spin mx-auto mb-3" />
            <p className="text-sm text-gray-500">Analysing organisation and generating role profiles…</p>
          </div>
        ) : (
